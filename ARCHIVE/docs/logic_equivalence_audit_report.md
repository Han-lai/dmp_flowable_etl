...
| 環境 | Host | Port | 表格 |
|------|------|------|------|
| Benchmark | REDACTED_IP | 8124 | `flowable_analytics.gold_proc_task_node_rmv`<br>`flowable_analytics.gold_procinst_node_rmv` |
| View | REDACTED_IP | 8121 | `silver.V_HI_PROC_TASK_NODE`<br>`silver.V_HI_PROCINST_NODE` |
| RMV | REDACTED_IP | 8121 | `silver.RMV_HI_PROC_TASK_NODE`<br>`silver.RMV_HI_PROCINST_NODE` |
