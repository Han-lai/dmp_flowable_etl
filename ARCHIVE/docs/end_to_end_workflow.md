...
| ClickHouse | 資料倉儲 | 10.136.218.207:8121 | 24.3+ |
...
client = clickhouse_connect.get_client(host='10.136.218.207', port=8121)
...
environment:
  ...
  - CUBEJS_DB_HOST=10.136.218.207
  - CUBEJS_DB_PORT=8121
  - CUBEJS_DB_USER=default
  - CUBEJS_DB_PASS=default
  - CUBEJS_DB_NAME=silver
  - CUBEJS_DEV_MODE=true
  - CUBEJS_API_SECRET=dmp_flowable_cube_secret_key_2026
```
...
| stg | 10.136.218.207:8121 | 4002/4003 | 測試環境（目前） |
