...
def check_clickhouse_data():
    """檢查 ClickHouse 中的資料"""
    print("=" * 80)
    print("ClickHouse 資料檢查 - WJ2+NBU+E5 2025-12-30")
    print("=" * 80)
    
    client = get_clickhouse_client()
    
    # 1. 檢查 Gold 層 2025-12-30 當天資料
    print("\n1. Gold 層 2025-12-30 當天資料...")
    ...
    if result.result_rows:
        ...
        print("  ❌ 無 2025-12-30 Gold 層資料")
    
    # 2. 檢查 Silver 層 2025-12-30 當天資料
    print("\n2. Silver 層 2025-12-30 當天資料...")
    ...
    if result.result_rows:
        ...
        print("  ❌ 無 2025-12-30 Silver 層資料")
    
    # 3. 檢查 Silver 層任務詳細資訊
    print("\n3. Silver 層 2025-12-30 任務詳細資訊...")
...
def check_mssql_data():
    """檢查 MSSQL 原始資料"""
    print("\n" + "=" * 80)
    print("MSSQL 原始資料檢查 - WJ2+NBU+E5 2025-12-30")
    print("=" * 80)
    ...
    try:
        ...
        # 2. 檢查 2025-12-30 Vx 歸屬邏輯
        print("\n2. 2025-12-30 Vx 歸屬邏輯...")
...
def main():
    """主要執行流程"""
    print("WJ2+NBU+E5 2025-12-30 數值驗證")
