...
SELECT
    ...
    -- is_excluded: V4 版本，對齊 MSSQL TaskBypass 邏輯
    -- ① autoComplete=1 → bypass
    -- ② SYSTEM 帳號 (hr.EmpName='SYSTEM') → system_bypass
    -- ③ 系統節點 (E%/C%) → system_node
    -- ④ Q/R 工單 → Q_order/R_order
    -- ⑤ 通知/虛擬任務 → notify_task/dummy_task
