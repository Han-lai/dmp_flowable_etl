...
│   └─ bpm_act_hi_* 表更新
│
├─ T1: Silver Layer 1 自動更新 (< 1 秒)
│   ├─ mv_varinst_pivoted 觸發更新
│   └─ mv_dim_mfg_five_level 觸發更新
│
├─ T2: Silver Layer 2 自動更新 (< 1 秒)
│   └─ mv_fact_task_vx 觸發更新
│
├─ T3: Gold 層刷新 (每小時)
...
| `sql/rebuild/02_silver_layer1.sql` | 2 | Silver L1 |
| `sql/rebuild/03_silver_layer2.sql` | 3 | Silver L2 |
| `sql/rebuild/04_gold_refreshable.sql` | 4 | Gold 層 |
| `sql/rebuild/05_cleanup_path_a.sql` | 5 | 清理舊架構 |
| `sql/rebuild/06_validation.sql` | 6 | 驗證 |
