...
- **版本**: `1.2.0`
- **內建文件 (Swagger)**: `http://REDACTED_IP:7088/docs`
...
```bash
curl -X 'GET' \
  'http://REDACTED_IP:7088/api/l5/task-report?month=2025-12&plant=WJ2' \
...
```bash
curl -X 'POST' \
  'http://REDACTED_IP:7088/api/l5/task-report' \
  -H 'accept: application/json' \
