...
def final_dec_audit():
    ...
    print(f"{'Date':<12} | {'Act':<5} | {'Included Users'}")
    print("-" * 100)
    ...
    for d in dates:
        ...
        try:
            ...
            WHERE t.TASK_DEF_KEY_ LIKE 'V3_5_%%'
              ...
              AND t.ASSIGNEE_ NOT LIKE 'DMPV%%'  -- Exclude System Accounts
            """
            ...
            print(f"{date_str:<12} | {cnt:<5} | {users_list}")
            sys.stdout.flush()
...
if __name__ == "__main__":
    output_file = 'd:/kiro/dmp_flowable/audit_result_dec.txt'
