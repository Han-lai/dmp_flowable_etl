...
print("=== Q1: TASK_DEF_KEY_ for WJ2/NPE/NPE3 on 12-25 ===")
q1 = """
SELECT TOP 15 t.TASK_DEF_KEY_, LEFT(t.TASK_DEF_KEY_, 5) AS key_prefix, COUNT(*) cnt
...
WHERE CAST(t.START_TIME_ AS DATE) = '2025-12-25'
  ...
  AND EXISTS(SELECT 1 FROM APP_SRV_BPM.dbo.ACT_HI_VARINST_0108 v WHERE v.PROC_INST_ID_=t.PROC_INST_ID_ AND v.NAME_='factory' AND v.TEXT_='NPE')
  AND EXISTS(SELECT 1 FROM APP_SRV_BPM.dbo.ACT_HI_VARINST_0108 v WHERE v.PROC_INST_ID_=t.PROC_INST_ID_ AND v.NAME_='lineName' AND v.TEXT_='NPE3')
GROUP BY t.TASK_DEF_KEY_, LEFT(t.TASK_DEF_KEY_, 5) ORDER BY cnt DESC
"""
print(pd.read_sql(q1, conn).to_string(index=False))

print("\n=== Q2: moNumber prefixes for WJ2/NPE/NPE3 on 12-25 ===")
q2 = """
