...
def verify_strict_member_logic():
    # Only verify WJ2 NBU E5 for now as per previous discrepancy analysis
    dates = ['2025-11-24', '2025-11-29', '2025-12-30']
    
    with open('d:/kiro/dmp_flowable/verify_strict_output_utf8.txt', 'w', encoding='utf-8') as f:
        sys.stdout = f
        ...
        for date_str in dates:
            ...
            try:
                ...
                for u in active_users:
                    ...
                    # Strict Rule: Must have V3 Node AND Only 'User' Group
                ...
                print(f"[{date_str}] Total Active (Action): {len(active_users)}, Valid Active (Strict): {valid_active_count}")
