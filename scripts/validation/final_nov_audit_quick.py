...
def final_nov_audit_quick():
    ...
    for d in dates:
        ...
        try:
            ...
            print(f"{date_str:<12} | {exp:<5} | {cnt:<5} | {match:<5} | {users_list}")
            sys.stdout.flush()
...
if __name__ == "__main__":
    output_file = 'd:/kiro/dmp_flowable/audit_result_nov_quick.txt'
    with open(output_file, 'w', encoding='utf-8') as f:
        sys.stdout = f
        final_nov_audit_quick()
